  ...
  return {
    DEFAULT: {
      css: {
        ...
        '--tw-prose-links-underline': theme('colors.indigo.700 / 0.3'),
        ...
        '--tw-prose-invert-links-hover': theme('colors.indigo.600'),
        '--tw-prose-invert-links-underline': theme('colors.indigo.600 / 0.3'),
