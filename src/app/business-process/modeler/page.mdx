...
<Row>
    ...
    <Col>
        <ImagePreview
            src="/images/processes/start_event.gif" alt="Start Event"/>
    </Col>
</Row>
...
<Row>
    ...
    <Col>
        <ImagePreview
            src="/images/processes/user_task.gif" alt="User Task"/>
    </Col>
...
<Row>
    <Col>
        ...
        - **Recipients:** Define the recipients of the message by adding corresponding phone numbers, email addresses or push notifications.
    ...
    <Col>
        <ImagePreview
            src="/images/processes/message_center_task.gif" alt="Message Center Task"/>
    </Col>
