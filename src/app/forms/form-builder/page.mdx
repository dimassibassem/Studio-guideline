...
<Row>
    <Col>
        <ImagePreview
            src="/images/forms/form-builder.gif" unoptimized alt="Form Builder interaction"/>
    </Col>
    <Col>
...
<Row>
    ...
    <Col>
        <ImagePreview
            src="/images/forms/forms_policy.gif" unoptimized alt="Policy secured form"/>
    </Col>
</Row>
...
After configuring the form, you can save it by clicking the save button at the top of the page. A modal will
appear where you can enter the form name, key, and description.
<Row>
    <Col>


        <Note>
            There is a checkbox asking if you want to publish the form, This allows users to
            explicitly mark whether a form should be published upon saving.

            While saving a form, the "Publish Form" checkbox appears.

            If checked, the form is marked as published and becomes immediately available.
        </Note>
    </Col>
    <Col>
        <ImagePreview
            src="/images/forms/save-form-modal.png" unoptimized alt="save form modal"/>
    </Col>
</Row>
